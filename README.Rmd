...
```{r, fig.retina = NULL, fig.align='center', fig.cap="Probabilistic graphical representation of the Melissa model", echo=FALSE}
knitr::include_graphics("analysis/model/figures/melissa-model.png")
```
