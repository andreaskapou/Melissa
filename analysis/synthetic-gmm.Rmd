...
pdf(file = paste0("out/synthetic/gmm/auc-synth.pdf"), width = 17, height = 6, useDingbats = FALSE)
final_fig_auc
dev.off()
```
...
pdf(file = paste0("out/synthetic/gmm/f-synth.pdf"), width = 17, height = 6, useDingbats = FALSE)
final_fig_f
dev.off()
```
