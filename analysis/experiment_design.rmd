...
suppressPackageStartupMessages(library(data.table))
suppressPackageStartupMessages(library(purrr))
dt <- data.table::data.table("Context" = c("Prom3k", "Prom5k", "Prom10k", "Active Enhancers", "Nanog", "Super Enhancers"), "CpGs (in millions)" = c("0.98", "1.54", "4.13", "0.85", "0.26", "0.29"), "Time" = c("09:58 - 11:17", "10:38 - 13:36", "11:19 - 15:24", "09:52 - 11:38", "08:35 - 09:30", "08:34 - 09:28"), "Time elapsed (in hours)" = c("1.31", "2.9", "4", "1.76", "0.91", "0.9"))
