...
#'
melissa_vb_par <- function(X, K = 3, basis = NULL, delta_0 = rep(1,K), w = NULL,
    ...
    if (is.null(w)) {
        ...
        for (t in 1:vb_init_nstart) {
            ...
            # Run mini-VB
            mini_vb <- melissa_vb_inner_par(H = H, y = y, region_ind = region_ind,
    ...
    # Run final VB
    obj <- melissa_vb_inner_par(H = H, y = y, region_ind = region_ind, cell_ind = cell_ind,
...
melissa_vb_inner_par <- function(H, y, region_ind, cell_ind, K, basis, w, delta_0,
